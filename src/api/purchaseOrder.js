...
/**
 * 获取采购单列表
 * @param {Object} params 查询参数，参考 purchase_order 表
 * @returns {Promise}
 */
...
/**
 * 获取待入库的采购单明细列表 (已收货但未完全入库)
 * @param {Object} params 查询参数 (如分页, po_number, supplierName, productKeyword)
 * @returns {Promise}
 */
export function getReceivablePurchaseOrderLines(params) {
  // 路径与 request.js 中的 Mock 路由对应
  return request.get('/purchase/orders/receivable-lines', params);
} 